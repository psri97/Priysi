resource "aws_instance" "public-servers" {
  ...
  tags = {
    ...
    sudo git clone https://github.com/rajeshrj94/webtesting.git
    sudo rm -rf /var/www/html/index.nginx-debian.html
    sudo cp webtesting/index.html /var/www/html/index.nginx-debian.html
    sudo cp webtesting/style.css /var/www/html/style.css
    sudo cp webtesting/scorekeeper.js /var/www/html/scorekeeper.js
